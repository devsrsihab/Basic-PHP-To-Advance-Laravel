					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class=""><a href="banner.php"><i class=" icon-menu2"></i>
										<span>Banners</span></a></li>
								<li class=""><a href="index.html"><i class="icon-hammer"></i>
										<span>Services</span></a></li>
								<li class=""><a href="index.html"><i class=" icon-grid4"></i>
										<span>Our Projects</span></a></li>
								<li class=" "><a href="index.html"><i class="icon-users4"></i>
										<span>Our Staff</span></a></li>
								<li class=""><a href="index.html"><i class="icon-hour-glass3"></i>
										<span>Our Clients</span></a></li>
								<li class=" "><a href="index.html"><i class="icon-bubbles9"></i>
								...
								<li>
									...
									<ul>
										...
										<li><a href="layout_sidebar_fixed_native.html">Designations</a>
										</li>
									</ul>
								</li>
