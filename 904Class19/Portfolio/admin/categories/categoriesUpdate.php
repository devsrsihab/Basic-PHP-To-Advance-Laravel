		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
				 ...
				 $dataId = $_GET['id'];
				 $getSingleDataQry = "SELECT * FROM categories WHERE id = {$dataId} ";
				 ...
				 ?>
					...
					<div class="panel panel-flat">
						...
						<form class="form-horizontal" action="../controller/categorieController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">

								<?php foreach ($singleDataResult as $categorie ) 
								...
								?>
									...
									<div class="form-group">
										<!-- hidden field fof id -->
										<input type="hidden" name="categories_id" value="<?php echo $categorie['id'] ?>" >
										<label class="control-label col-lg-2" for="category_name">Categorie Name</label>
										<div class="col-lg-10">
											<input id="category_name" name="category_name" type="text"
												class="form-control" value="<?php echo $categorie['category_name'] ?>">
										</div>
									</div>
								...
								<div class="text-right">
									...
									<a href="categoriesLIst.php" class="btn btn-warning">Back To Banner List</i></a>
								</div>
							</form>
