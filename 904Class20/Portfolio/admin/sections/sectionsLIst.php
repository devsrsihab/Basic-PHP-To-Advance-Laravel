			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="sections.php"><i class="icon-menu2 position-left"></i> sections</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table table-bordered table-striped datatable-basic ">
							...
							$sectionsList = mysqli_query($conn, $SelectQry);
							foreach ($sectionsList as $key => $section) {
								...
								<tr>
									...
									<td> <?php echo $section['active_status']; ?> </td>
									<td class="text-center">
							  <a href="sectionsUpdate.php?id=<?php echo $section['id']; ?>" class="ml-2 mr-2"><i class="icon-pencil5"></i></a>
							  <a href="sectionsDelete.php?id=<?php echo $section['id']; ?>" class="ml-2 mr-2"><i class=" icon-trash"></i></a>
									</td>
								</tr>
							<?php	} ?>
							</tbody>
