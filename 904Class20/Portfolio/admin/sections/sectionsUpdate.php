		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
				 ...
				 $dataId = $_GET['id'];
				 $getSingleDataQry = "SELECT * FROM sections WHERE id = {$dataId} ";
				 ...
				 ?>
					...
					<div class="panel panel-flat">
						...
						<form class="form-horizontal" action="../controller/sectionsController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">

								<?php foreach ($singleDataResult as $section ) 
								...
								?>
									...
									<div class="form-group">
										...
										<label class="control-label col-lg-2" for="title">Section Title</label>
										<div class="col-lg-10">
											<input id="title" name="title" type="text"
												class="form-control" value="<?php echo $section['title'] ?>">
										</div>
									</div>
									<div class="form-group">					
										<label class="control-label col-lg-2" for="sub_title">Sub Title</label>
										<div class="col-lg-10">
										<input id="sub_title" name="sub_title" type="text" class="form-control" value="<?php echo $section['sub_title'] ?>">
										</div>
									</div>
									<div class="form-group">					
										<label class="control-label col-lg-2" for="details">Details</label>
										<div class="col-lg-10">
										<input id="details" name="details" type="text" class="form-control" value="<?php echo $section['details'] ?>">
										</div>
									</div>
									<div class="form-group">					
										<label class="control-label col-lg-2" for="page_no">Page No.</label>
										<div class="col-lg-10">
										<input id="page_no" name="page_no" type="text" class="form-control" value="<?php echo $section['page_no'] ?>">
										</div>
									</div>
								...
								<div class="text-right">
									...
									<a href="sectionsLIst.php" class="btn btn-warning">Back To Banner List</i></a>
								</div>
							</form>
