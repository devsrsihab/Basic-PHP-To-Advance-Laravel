					...
					<div class="panel panel-flat">
						<div class="panel-heading mb-5">
							...
							<div class="heading-elements">
								<ul class="icons-list">
									<li><a href="sectionsCreate.php" class="btn btn-primary add_new">Add New</a></li>
							...
							<form class="form-horizontal" action="../controller/sectionsController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">
									...
									<label class="control-label col-lg-2" for="page_no">Page No.</label>
										<div class="col-lg-10">
											<input id="page_no" name="page_no" type="number"
												class="form-control">
										</div>
									</div>
								...
								<div class="text-right">
									<button type="submit" name="CreateData" class="btn btn-primary">Create <i
											class="icon-arrow-right14 position-right"></i></button>
									<a href="sectionsLIst.php" class="btn btn-warning">Back To Designations List</i></a>
								</div>
							</form>
