				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table table-bordered table-striped datatable-basic ">
							...
							$designationsList = mysqli_query($conn, $SelectQry);
							foreach ($designationsList as $key => $designation) {
								...
								<tr>
									...
									<td> <?php echo $designation['active_status']; ?> </td>
									<td class="text-center">
							  <a href="designationsUpdate.php?id=<?php echo $designation['id']; ?>" class="ml-2 mr-2"><i class="icon-pencil5"></i></a>
							  <a href="designationsDelete.php?id=<?php echo $designation['id']; ?>" class="ml-2 mr-2"><i class=" icon-trash"></i></a>
									</td>
								</tr>
							<?php	} ?>
							</tbody>
