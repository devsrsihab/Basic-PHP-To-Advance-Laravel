					...
					<?php if (isset($_GET['msg'])) {
						...
						<form class="form-horizontal" action="../controller/servicesController.php" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2" for="serviceDetails"  >Services Details</label>
										<div class="col-lg-10">						
											<textarea id="serviceDetails" name="serviceDetails" rows="5" cols="5" class="form-control" placeholder="Default textarea"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2" for="iconName">Icon Name</label>
										<div class="col-lg-10">
										<input id ="iconName" name="iconName"  type="text" class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2" for="designStatus"  >Design Status</label>
										<div class="col-lg-10">
											<input id ="designStatus" name ="designStatus" type="number" class="form-control">
										</div>
									</div>
								</fieldset>
								...
								<div class="text-right">
									...
									<a href="ServicesList.php"class="btn btn-warning">Back To Services List</i></a>
								</div>
							</form>
